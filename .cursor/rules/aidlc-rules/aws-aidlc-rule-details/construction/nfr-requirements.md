...
- Read functional design artifacts from `aidlc-docs/branches/{branch}/construction/{unit-name}/functional-design/`
...
### Step 4: Store Plan
- Save as `aidlc-docs/branches/{branch}/construction/plans/{unit-name}-nfr-requirements-plan.md`
...
- Create `aidlc-docs/branches/{branch}/construction/{unit-name}/nfr-requirements/nfr-requirements.md`
- Create `aidlc-docs/branches/{branch}/construction/{unit-name}/nfr-requirements/tech-stack-decisions.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR requirements at: `aidlc-docs/branches/{branch}/construction/{unit-name}/nfr-requirements/`
...
- Mark NFR Requirements stage complete in `aidlc-docs/state/{branch}.md`
